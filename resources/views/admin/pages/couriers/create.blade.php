        ...
        <div class="card-body">
            <form action="{{ route('admin.couriers.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="merchant_id" class="form-control" required value="{{ old('merchant_id') }}" >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="api_key" class="form-control" required value="{{ old('api_key') }}">
                </div>

                <div class="form-group">
                    <label for="secret_key">API Secret *</label>
                    <input type="text" name="secret_key" class="form-control" required value="{{ old('secret_key') }}">
                </div>
