<div class="btn-group btn-group-sm" role="group">
    <a href="{{ route('admin.couriers.show', $courier->id) }}"
    ...
    {{-- <form width="0px"  action="{{ route('admin.couriers.destroy', $courier->id) }}"
    ...
    <button type="button" class="btn btn-danger p-0 py-1 px-2 border-none delete-btn"
                title="Delete"
                data-action="{{ route('admin.couriers.destroy', $courier) }}"
